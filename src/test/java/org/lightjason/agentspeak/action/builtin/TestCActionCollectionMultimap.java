...
import org.lightjason.agentspeak.action.builtin.map.multimap.CAsMap;
import org.lightjason.agentspeak.action.builtin.map.multimap.CCreate;
import org.lightjason.agentspeak.action.builtin.map.multimap.CGetMultiple;
import org.lightjason.agentspeak.action.builtin.map.multimap.CGetSingle;
import org.lightjason.agentspeak.action.builtin.map.multimap.CKeys;
import org.lightjason.agentspeak.action.builtin.map.multimap.CPutMultiple;
import org.lightjason.agentspeak.action.builtin.map.multimap.CPutSingle;
import org.lightjason.agentspeak.action.builtin.map.multimap.CValues;
