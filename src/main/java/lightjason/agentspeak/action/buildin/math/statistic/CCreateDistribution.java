...
package lightjason.agentspeak.action.buildin.math.statistic;
...
public final class CCreateDistribution extends IBuildinAction
{
    ...
    )
    {
        ...
        if ( p_argument.size() < l_requiredarguments )
            throw new CIllegalArgumentException( lightjason.agentspeak.common.CCommon.getLanguageString( this, "distributionarguments" ) );
