...
package lightjason.agentspeak.action.buildin.math.blas;
...
public final class CMultiply extends IAlgebra
{
    ...
    )
    {
        ...
        final AbstractMatrix l_first = CCommon.getRawValue( p_argument.get( 0 ) );
        final AbstractMatrix l_second = CCommon.getRawValue( p_argument.get( 1 ) );
