...
import lightjason.agentspeak.language.execution.expression.logical.CBinary;
...
final class CCommon
{
    ...
    )
    {
        if ( ( !p_operator.isBinary() ) || ( !p_operator.isLogical() ) )
            throw new CSyntaxErrorException( lightjason.agentspeak.common.CCommon.getLanguageString( CCommon.class, "notbinarylogicoperator", p_operator ) );
