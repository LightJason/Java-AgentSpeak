...
public class CVariable<T> implements IVariable<T>
{
    ...
    {
        if ( !this.isAllocated() )
            throw new CIllegalStateException( lightjason.agentspeak.common.CCommon.getLanguageString( CVariable.class, "notallocated", this ) );
    ...
    public IVariable<T> throwValueNotAssignableTo( final Class<?>... p_class ) throws IllegalArgumentException
    {
        if ( !this.isValueAssignableTo( p_class ) )
            throw new CIllegalArgumentException(
                lightjason.agentspeak.common.CCommon.getLanguageString( CVariable.class, "notassignable", this, Arrays.asList( p_class ) ) );
    ...
    protected final IVariable<T> internalset( final T p_value )
    {
        ...
        if ( !m_any )
            m_value = lightjason.agentspeak.language.CCommon.getRawValue( p_value );
        return this;
    }
}
