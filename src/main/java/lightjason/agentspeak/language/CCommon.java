...
import lightjason.agentspeak.language.execution.CContext;
...
public final class CCommon
{
    ...
    public static ITerm replaceFromContext( final IContext p_context, final ITerm p_term )
    {
        ...
        throw new CIllegalArgumentException(
            lightjason.agentspeak.common.CCommon.getLanguageString( CCommon.class, "variablenotfoundincontext", p_term.getFQNFunctor() )
        );
    }
