...
public final class CComparable extends IBaseBinary
{
    ...
    {
        final Object l_value1 = lightjason.agentspeak.language.CCommon.getRawValue( p_value1 );
        final Object l_value2 = lightjason.agentspeak.language.CCommon.getRawValue( p_value2 );
