...
package lightjason.agentspeak.language.instantiable.plan.trigger;
...
public final class CTrigger implements ITrigger
{
    ...
    public CTrigger( final EType p_event, final ILiteral p_literal )
    {
        ...
        m_event = p_event;
        m_literal = p_literal;
        m_variables = lightjason.agentspeak.language.CCommon.getVariableFrequency( p_literal ).size();
