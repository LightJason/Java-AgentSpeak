...
public final class CRawTerm<T> implements IRawTerm<T>
{
    ...
    {
        if ( !this.isAllocated() )
            throw new CIllegalStateException( lightjason.agentspeak.common.CCommon.getLanguageString( this, "notallocated", p_name != null ? p_name[0] : this ) );
    ...
    public final IRawTerm<T> throwValueNotAssignableTo( final Class<?>... p_class ) throws IllegalArgumentException
    {
        if ( !this.isValueAssignableTo( p_class ) )
            throw new CIllegalArgumentException( lightjason.agentspeak.common.CCommon.getLanguageString( this, "notassignable", this, p_class ) );
