 ...
 * a list with the symmetric difference \f$ (\mathbb{X} \setminus \matbb{Y}) \cup (\mathbb{B} \setminus \mathbb{A}) \f$
 *
...
public final class CSymmetricDifference extends IBuildinAction
{
    ...
    )
    {
        ...
        CCommon.flatcollection( p_argument ).parallelStream().forEach( i -> l_count.add( i.raw() ) );
