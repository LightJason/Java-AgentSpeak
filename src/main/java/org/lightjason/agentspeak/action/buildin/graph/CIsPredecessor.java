 ...
 *
 * @code [B1|B2|B3] = graph/ispredecessor( Vertex1, Vertex2, Graph1, Graph2, Graph3 ); @endcode
 */
public final class CIsPredecessor extends IBuildinAction
{
                                               ...
                                               final List<ITerm> p_annotation )
    {
        ...
        l_arguments.stream()
                   ...
                   .map( i -> i.isPredecessor( l_arguments.get( 0 ).raw(), l_arguments.get( 1 ).raw() ) )
                   .map( CRawTerm::from )
