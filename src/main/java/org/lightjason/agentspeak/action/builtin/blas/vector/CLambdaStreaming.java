 ...
 * streaming a vector
 */
public final class CLambdaStreaming extends IBaseLambdaStreaming<DoubleMatrix1D>
{
    /**
     * serial id
     */
    private static final long serialVersionUID = -4092413210478148636L;

    @Override
    public Stream<?> apply( final DoubleMatrix1D p_vector )
    {
