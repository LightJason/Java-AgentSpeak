...
public final class COneNorm extends IBaseAlgebra
{
     ...
     * serial id
     */
    private static final long serialVersionUID = 4029664578615748263L;
    /**
     * action name
     */
    private static final IPath NAME = namebyclass( COneNorm.class, "math", "blas", "matrix" );
