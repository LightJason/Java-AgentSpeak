 ...
 * is calculates and returned
 *
 * {@code [N1|N2] = .math/blas/matrix/matrixnorm(M1,M2);}
 *
 * @see https://en.wikipedia.org/wiki/Matrix_norm
 */
public final class CMatrixNorm extends IBaseAlgebra
{
    /**
     * serial id
     */
    private static final long serialVersionUID = 6398446043888400390L;
    /**
     * action name
     */
    private static final IPath NAME = namebyclass( CMatrixNorm.class, "math", "blas", "matrix" );
