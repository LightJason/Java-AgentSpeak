...
public final class CSmoothBoolean implements IFuzzySet<Number, EBoolean>
{
     ...
     * ctor
     */
    public CSmoothBoolean( @NonNull final Number p_precision )
    {
        this(
            i -> 1.0 / ( 1.0 + Math.exp( -( i.doubleValue() - 0.5 ) * 10 ) ),
            i -> 1 - 1.0 / ( 1.0 + Math.exp( -( i.doubleValue() - 0.5 ) * 10 ) ),
            p_precision
        );
    }
     ...
     */
    private CSmoothBoolean( @NonNull final Function<Number, Number> p_true, @NonNull final Function<Number, Number> p_false, @NonNull final Number p_precision )
    {
        m_true = p_true;
        m_false = p_false;
