...
public final class CExpressionUnify extends CDefaultUnify
{
    ...
    {
        return m_parallel
               ? p_context.getAgent().unifier().parallel( p_context, m_value, m_variablenumber, m_expression )
               : p_context.getAgent().unifier().sequential( p_context, m_value, m_variablenumber, m_expression );
    }
